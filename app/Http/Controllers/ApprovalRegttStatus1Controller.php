...
class ApprovalRegttStatus1Controller extends Controller
{
    public function index(Request $request)
    {
    	...
    	return view('approval/regtt_1/index');
    }

    public function search(Request $request)
    {
        return redirect("approval_1_regtt/" . $request->id_personal);
    }
    ...
    public function list(Request $request)
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => config("app.lpjk_endpoint") . "LPJK-Service/Klasifikasi/Get-TT",
        ...
        return view('approval/regtt_1/list')->with($data);
    }
