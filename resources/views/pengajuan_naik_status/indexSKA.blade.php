              ...
              <tbody>
                @foreach($pengajuan as $k => $result)
                  <tr>
                    ...
                    <td><a class="fancybox" href={{"/document?profesi=1&data=" . \Illuminate\Support\Facades\Crypt::encryptString($result->id_personal . "." . date('Y-m-d', strtotime($result->date)))}}>View</a></td>
                    <td>
