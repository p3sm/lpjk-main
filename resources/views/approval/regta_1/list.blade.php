...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        <a href="{{url("approval_1_regta")}}" class="btn btn-danger btn-sm"><i class="fa fa-arrow-left"></i> kembali</a> 
                    ...
                    <tbody>
                        @foreach($results as $k => $result)
                          <tr>
                            ...
                            <td>
                              {{-- <a data-team="{{($role == 1 || $role == 2) ? "1" : "0"}}" href="{{url("approval_1_regta/" . $result->ID_Asosiasi_Profesi . "/approve") . '?' . http_build_query($result)}}" class="btn btn-primary btn-xs approve">Approve</a> --}}
                              <a href="{{url("approval_1_regta/" . $result->ID_Asosiasi_Profesi . "/approve") . '?' . http_build_query($result)}}" class="btn btn-primary btn-xs">Approve</a>
                            </td>
                          </tr>
                        @endforeach
                    </tbody>
